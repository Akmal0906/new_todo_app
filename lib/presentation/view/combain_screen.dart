            ...
            return Scaffold(
              ...
              floatingActionButton: GestureDetector(
                onTap: () async {
                  ...
                  print('On tappped ${state.isCorrect}');
                              ...
                              children: [
                                ...
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      hintText: 'Write task',
                                      hintStyle: customStyle.copyWith(
                                          color: Colors.black)),
                                ),
                                Column(
                                  children: [
                ...
                child: Container(
                  ...
                  child: Icon(
                    state.isCorrect ? Icons.cancel_sharp : Icons.add,
                    color: Colors.white,
                    size: 24,
                  ),
                ),
...
// void func(bool state, BuildContext context, GlobalKey<ScaffoldState> key,
//     PersistentBottomSheetController? controller) {
//   int? tapIndex;
//   TextEditingController textEditingController = TextEditingController();
//   List<String> timeList = [];
//   print('Function working $state');
//
//   if (state) {
//     print('true');
//
...
//                                     blurRadius: 6,
//                                     offset: Offset(0, 3),
//                                     color: Color.fromRGBO(104, 148, 238, 1))
//                               ],
//                               gradient: const LinearGradient(
//                                   begin: Alignment.topLeft,
//                                   end: Alignment.bottomRight,
